...
@section('content')
    <div class="row">
        <div class="col-sm-10 title">
            <h1><i class="fa fa-bars"></i> Add Service</h1>
        </div>
            ...
            <div class="row">
                ...
                <form method="post" action="{{url('addservice')}}" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <input type="number" name="min_pages" class="form-control" placeholder="Enter Minimum pages per site here">
                        </div>
                        <div class="form-group">
                            <label for="min_charges">Minimum Charges</label>
                        </div>
                        <div class="form-group">
                            <input type="text" name="min_charges" class="form-control" placeholder="Enter Minimum Charges here">
                        </div>
                        <div class="form-group">
                            <label for="description">Description</label>
                        </div>
                        <div class="form-group">
                            <textarea name="description" class="form-control" placeholder="Enter Description Here" rows="6"></textarea>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="number" name="max_pages" class="form-control" placeholder="Enter Maximum pages per site here">
                        </div>
                        <div class="form-group">
                            <label for="max_charges">Maximum Charges</label>
                        </div>
                        <div class="form-group">
                            <input type="text" name="max_charges" class="form-control" placeholder="Enter Maximum Charges here">
                        </div>
                        <div class="form-group">
