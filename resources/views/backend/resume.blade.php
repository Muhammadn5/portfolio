        ...
        <div class="col-sm-12">
            <div class="row">
                <div class="col-sm-4">
                    ...
                    @endif
                    <form method="post" action="{{url('add-to-resume')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            <input type="text" name="started_at" class="form-control" placeholder="Enter starting date Here">
                        </div>
                        <div class="form-group">
                            <label for="left">Left at</label>
                        </div>
                        <div class="form-group">
                            <input type="text" name="ended_at" class="form-control" placeholder="Enter left date Here">
                        </div>
                        <div class="form-group">
