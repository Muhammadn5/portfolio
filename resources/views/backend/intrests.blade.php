        ...
        <div class="col-sm-12">
            <div class="row">
                <div class="col-sm-4">
                    ...
                    @endif
                    <form method="post" action="{{url('add-intrest')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            <input type="text" name="title" class="form-control" placeholder="Enter interest title here">
                        </div>
                        <div class="form-group">
                            <label for="url">Some Link</label>
                        </div>
                        <div class="form-group">
                            <input type="text" name="url" class="form-control" placeholder="Enter project-Link here">
